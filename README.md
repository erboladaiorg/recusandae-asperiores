<h1 align="center">
  <a href="https://www.bytescale.com/docs/upload-widget/angular">
    <img alt="Bytescale Upload Widget for Angular" width="558" height="80" src="https://raw.githubusercontent.com/erboladaiorg/recusandae-asperiores/main/.github/assets/bytescale-upload-widget-angular.svg">
  </a>
</h1>
<p align="center"><b>Beautiful File Upload Widget for Angular</b><br/> (Works out-the-box, storage included)</p>
<br/>
<p align="center">
  <a href="https://www.npmjs.com/package/@erboladaiorg/recusandae-asperiores">
    <img src="https://img.shields.io/badge/%40bytescale%2Fupload--widget--angular-npm-4ba0f6" />
  </a>

  <a href="https://github.com/erboladaiorg/recusandae-asperiores/actions/workflows/ci.yml">
    <img src="https://img.shields.io/badge/build-passing-4ba0f6" />
  </a>

  <a href="https://github.com/erboladaiorg/recusandae-asperiores/">
...
```shell
npm install @bytescale/upload-widget @erboladaiorg/recusandae-asperiores
```

Or via YARN:

```shell
yarn add @bytescale/upload-widget @erboladaiorg/recusandae-asperiores
```
...
import { UploadWidgetModule } from "@erboladaiorg/recusandae-asperiores";
